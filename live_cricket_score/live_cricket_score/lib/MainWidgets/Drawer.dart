...
<p> <B> We collect information from you when you register on our appss.</B></p>
...
<p><B>  How do we use your information?</B><br>
    ...
    • To administer a contest, promotion, survey or other site feature.</p><br>
...
<p>    We implement a variety of security measures when a user enters, submits, or accesses their information to maintain the safety of your personal information.</p>
   <p> <b>We take permission like
    ...
    android.permission.RECORD_AUDIO but do not share any information.
       All transactions are processed through a gateway provider and are not stored or processed on our servers.</b></p>
      ...
      child: Container(
        child: ListView(
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(child: Text("Cricket Live Score",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),margin: EdgeInsets.symmetric(horizontal: 5.w),)
                ],
              ),
            ),
            ListTile(
              onTap: () => _launchURL(
                  "https://play.google.com/store/apps/details?id=com.kimsoladavo.cricketscore"),
            ...
            ListTile(
              onTap: () => _launchURL(
                  "https://play.google.com/store/apps/developer?id=kimsola+davo"),
              leading: SvgPicture.asset(
                      ...
                      return Container(
                        ...
                        child: WebView(
                          ...
                          onWebViewCreated: (WebViewController webViewController) {
                            webViewController.loadUrl(Uri.dataFromString(str,mimeType: 'text/html', encoding: Encoding.getByName('utf-8')).toString());
                          },
                        ),
                      );
                    });
