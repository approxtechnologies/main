...
class PLayerBattingInfoTab extends StatefulWidget {
  final String id;
  const PLayerBattingInfoTab({
    Key? key,
    required this.id,
  }) : super(key: key);

  @override
  State<PLayerBattingInfoTab> createState() => _Player_BattingInfo_TabState(id);
}

class _Player_BattingInfo_TabState extends State<PLayerBattingInfoTab>
    with AutomaticKeepAliveClientMixin<PLayerBattingInfoTab> {
  @override
  ...
  _Player_BattingInfo_TabState(this.id);
  ...
  getData() async {
    ...
    var response = await http.get(Utils.getUrl(Utils.BATTINGINFO, parameters),
